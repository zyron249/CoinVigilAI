...
import { lotPnl, PORTFOLIO_LIMIT, usePortfolio } from "../lib/portfolio";
...
export function PortfolioBoard({ initialCoin = "bitcoin" }: { initialCoin?: string }) {
  ...
  const totals = useMemo(() => {
    ...
    const pnl = costed ? value - costUsd : null;
    return { value: valued ? value : null, costUsd: costed ? costUsd : null, pnl, valued, costed };
  }, [items, byId]);
